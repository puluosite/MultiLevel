function [ voltage, current ] = cwModel( pattern, levels, n_bypass, parameters )
%CWMODEL Summary of this function goes here
%   Detailed explanation goes here
% parameters, must be the same as in gtModel!!!!
...
% insert the colony into spice file
% topology
%       1   1   1   1
%bp1    11  12  13  14
%bp2    21  22  23  24
...
dos(['"C:\synopsys\Hspice_C-2009.03-SP1\BIN\hspice.exe" -i cwModel.sp']);

%run python to analyse the .lis file for matlab analysis
system('cwModel.py');

%matlab plot I-V curve and P-V curve
data = xlsread('output_cwModel.csv');
voltage = data(:,1);
current = data(:,2);
end
